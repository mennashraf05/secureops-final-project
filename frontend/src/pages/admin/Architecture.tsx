...
const nodes = ['Client / Browser','API Gateway','Identity Service','Inventory Domain','Order Domain','Secure File Vault','Report Domain','Background Processing','Managed Data Store','Async Queue','Audit Events','Security Center'];
export default function Architecture() {
 ...
 <section className="mt-7 grid gap-5 lg:grid-cols-3"><SectionCard title="Gateway Layer" subtitle="Public traffic is routed, rate limited, and filtered before service access."/><SectionCard title="Service Layer" subtitle="Application domains are separated behind controlled gateway routes."/><SectionCard title="Security Controls" subtitle="JWT validation, RBAC, internal API keys, audit events, encryption, SHA-256 integrity."/></section>
 </>;
}
