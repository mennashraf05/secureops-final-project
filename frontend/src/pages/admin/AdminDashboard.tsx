...
export default function AdminDashboard() {
  ...
  async function generateReport() {
    ...
    try {
      const response = await createInventoryReport();
      setQuickActionMessage(response.message || 'Inventory report job created successfully.');
      await loadDashboard();
